Function config_json_transforms()
  ...
  'TStarfarerSkin - omit unchanged fields in X_SlotChanges by detecting poisoned default values
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$angle:number", json.XJ_DELETE,, predicate_omit_if_equals_FLOAT_MAX )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$arc:number", json.XJ_DELETE,, predicate_omit_if_equals_FLOAT_MAX )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$id:string", json.XJ_DELETE,, predicate_omit_if_empty_string )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$locations:array", json.XJ_DELETE,, predicate_omit_if_empty_array )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$position:array", json.XJ_DELETE,, predicate_omit_if_empty_array )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$mount:string", json.XJ_DELETE,, predicate_omit_if_empty_string )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$size:string", json.XJ_DELETE,, predicate_omit_if_empty_string )
  json.add_transform( "stringify_skin", "$weaponSlotChanges/:object/$type:string", json.XJ_DELETE,, predicate_omit_if_empty_string ) ' Why "type" and not "type_"? These transforms are processed in-order, and the field will have already been renamed (above)
