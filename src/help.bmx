...
Function load_help()
	...
	HELP_WIDGETS.AddLast( TKeyboardHelpWidget.Create( "N", LocalizeString("{{h_mode_ship_builtInWings}}"), ICON_KB, True, 0, "ship" ))
	...
	HELP_WIDGETS.AddLast( TKeyboardHelpWidget.Create( "U", LocalizeString("{{h_mode_skin_builtInweapons}}"), ICON_KB, True, 0, "skin" ))
