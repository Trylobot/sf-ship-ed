...
Function load_help()
	...
	HELP_WIDGETS.AddLast( TKeyboardHelpWidget.Create( "P", LocalizeString("{{h_mode_ship_preview}}"), ICON_KB, True, 1, "ship" ) )
	'////////////
	...
	HELP_WIDGETS.AddLast( TKeyboardHelpWidget.Create( "F5", LocalizeString("{{h_global_weaponDrawer}}"), 0, True, 0 ))
